...
import edu.uw.tcss450.chatapp.databinding.FragmentSendPasswordChangeRequestBinding;
 ...
 */
public class SendPasswordChangeRequest extends Fragment {

    private FragmentSendPasswordChangeRequestBinding binding;
    private SendPasswordChangeRequestViewModel mSendPasswordChangeRequestViewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSendPasswordChangeRequestViewModel = new ViewModelProvider(getActivity())
                .get(SendPasswordChangeRequestViewModel.class);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentSendPasswordChangeRequestBinding.inflate(inflater);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mSendPasswordChangeRequestViewModel.addResponseObserver(
                getViewLifecycleOwner(),
                this::observeSignInResponse);

        SendPasswordChangeRequestArgs args = SendPasswordChangeRequestArgs.fromBundle(getArguments());
    ...
    private void validEmailResetPassword() {
        mSendPasswordChangeRequestViewModel.connect(binding.emailTextField.getText().toString());
    }
    ...
    private void navigateBackToSignIn(View view) {
        Navigation.findNavController(getView()).navigate(
                SendPasswordChangeRequestDirections
                        .actionSendPasswordChangeRequestToSignInFragment());

        Navigation.findNavController(requireView()).popBackStack(
                R.id.sendPasswordChangeRequest, true);
    }
}